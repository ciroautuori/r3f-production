> **Fonte**: [Impertio-Studio/Three.js-Claude-Skill-Package](https://github.com/Impertio-Studio/Three.js-Claude-Skill-Package) - threejs-impl-webgpu/references/methods.md

> **Errata (luglio 2026)**: importa TSL (compute, storage, nodi) sempre da three/tsl, non da three/webgpu; browser matrix corretta: Chrome/Edge 113+, Firefox 141+ Windows / 145+ macOS ARM, Safari 26+; da three r181 render()/compute() sono sincroni e le versioni *Async sono deprecate; entry point post-processing: pass(scene, camera) con renderOutput() come nodo finale.
