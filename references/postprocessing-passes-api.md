> **Fonte**: [Impertio-Studio/Three.js-Claude-Skill-Package](https://github.com/Impertio-Studio/Three.js-Claude-Skill-Package) - threejs-impl-post-processing/references/methods.md

> **Nota**: con three r154+ il pass finale e OutputPass (mai GammaCorrectionShader); in R3F v9 usa @react-three/postprocessing (pmndrs) - queste signature vanilla restano il riferimento API di base.
